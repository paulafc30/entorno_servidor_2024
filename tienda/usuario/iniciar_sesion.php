    ...
    <div class="container">
        ...
        if($_SERVER["REQUEST_METHOD"]== "POST"){
            ...
            if($resultado -> num_rows == 0){
                $err_usuario = "El usuario $usuario no existe, tienes que registrarte";
            }else{
    ...
    ?>
        <form class="col-6" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <a class="btn btn-secondary" href="../index.php">Volver a Inicio</a><br><br>
            </div>
            <div class="mb-3">
                <h5>O, si aún no tienes cuenta registrate</h5>
                <a class="btn btn-primary" href="registro.php">Registrarse</a><br><br>
            </div>
        </form>
    </div>
